...
public class GenerateProduct {
    ...
    private void generateTimberland() {
        Suppliers nike = new Suppliers("Timberland", factory);

        // High Heels
        Shoes shoe = nike.createShoe(ShoeType.HIGH_HEELS);
        shoe.setSupplier("Timberland");
        ...
        shoe = nike.createShoe(ShoeType.HIGH_HEELS);
        shoe.setSupplier("Timberland");
